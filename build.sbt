...
val repo = "lanag-iteratedlearning-and-asymmetry"
...
lazy val commonSettings = Seq(
  ...
  description := "This is an implementation of the iterated learning paradigm to explore asymmetry.",
  ...
  libraryDependencies ++= Seq(
    ...
    "com.markblokpoel" %% "lanag-ambiguityhelps" % "0.9.2",
